...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=628885859040:+62 888-5859-040\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["628885859040@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["628885859040@s.whatsapp.net"] // GANTI NOMOR LU
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('628885859040@s.whatsapp.net', options, text, {quoted: mek})
